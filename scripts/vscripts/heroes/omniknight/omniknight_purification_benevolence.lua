...
omniknight_purification_benevolence = class({})


function omniknight_purification_benevolence:GetIntrinsicModifierName()
...
function modifier_omniknight_purification_benevolence:OnCreated(kv)
    if IsServer() then
       local unit = self:GetCaster()
        unit:AddNewModifier(unit, unit:FindAbilityByName("omniknight_purification"), "modifier_generic_2_charges", { })
    end
end
