queenofpain_scream_of_pain_knockback = class( {} )

LinkLuaModifier( "modifier_queenofpain_scream_of_pain_knockback", "heroes/queenofpain/queenofpain_scream_of_pain_knockback", LUA_MODIFIER_MOTION_NONE )
...
function queenofpain_scream_of_pain_knockback:GetIntrinsicModifierName()
	return "modifier_queenofpain_scream_of_pain_knockback"
end


modifier_queenofpain_scream_of_pain_knockback = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_queenofpain_scream_of_pain_knockback:IsHidden()
	return true
end

function modifier_queenofpain_scream_of_pain_knockback:IsPurgeException()
	return false
end

function modifier_queenofpain_scream_of_pain_knockback:IsPurgable()
	return false
end

function modifier_queenofpain_scream_of_pain_knockback:IsPermanent()
	return true
end



function modifier_queenofpain_scream_of_pain_knockback:OnCreated(kv)
    if IsServer() then
...
function modifier_queenofpain_scream_of_pain_knockback:DeclareFunctions()
    return {
        MODIFIER_EVENT_ON_TAKEDAMAGE,
    }
end
function modifier_queenofpain_scream_of_pain_knockback:OnTakeDamage(params)
    ...
    if params.inflictor and params.inflictor:GetAbilityName() == "queenofpain_scream_of_pain" then
       self.queenofpain_scream_of_pain = params.attacker:FindAbilityByName("queenofpain_scream_of_pain")
       local origin =params.attacker:GetOrigin()
       local duration = 0.3
	    local distance = self.queenofpain_scream_of_pain:GetSpecialValueFor("area_of_effect")
