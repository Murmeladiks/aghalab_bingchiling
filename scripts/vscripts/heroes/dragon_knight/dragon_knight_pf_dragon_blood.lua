...
function dragon_knight_pf_dragon_blood:GetCastPoint()
	return self:GetCaster():GetSpecialValueFor("pathfinder_dk_dragon_blood_active", "cast_point")
end
...
function dragon_knight_pf_dragon_blood:GetBehavior()
	if self:GetCaster():HasAbility("pathfinder_dk_dragon_blood_active") then
...
function dragon_knight_pf_dragon_blood:OnSpellStart()
	...
	local nDuration = hCaster:GetSpecialValueFor("pathfinder_dk_dragon_blood_active", "duration")
	local nRadius = hCaster:GetSpecialValueFor("pathfinder_dk_dragon_blood_active", "radius")
	local nStunDuration = hCaster:GetSpecialValueFor("pathfinder_dk_dragon_blood_active", "stun_duration")
	local nRegenToDamagePct = hCaster:GetSpecialValueFor("pathfinder_dk_dragon_blood_active", "regen_damage_mult") / 100
...
function modifier_dragon_knight_pf_dragon_blood_boiling_veins:OnCreated()
	if IsClient() then return end
	self.nMaxStacks = self:GetParent():GetSpecialValueFor("pathfinder_dk_dragon_blood_damage", "max_stack")
