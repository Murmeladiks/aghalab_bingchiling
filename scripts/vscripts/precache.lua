...
g_ModelPrecache =
{
	...
	"models/creeps/darkreef/blob/darkreef_blob_02_small.vmdl",
	"models/creeps/ice_biome/penguin/penguin.vmdl",
	"models/creeps/tower_dire_rock_golem/tower_dire_rock_golem_custom_game.vmdl",
	"models/heroes/gyro/gyro_missile.vmdl",
	"models/creeps/ice_biome/ogreseal/ogreseal_undead.vmdl",
	...
	"models/creeps/darkreef/gaoler/darkreef_gaoler.vmdl",
