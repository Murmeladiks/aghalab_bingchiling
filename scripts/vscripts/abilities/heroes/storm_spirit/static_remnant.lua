...
function aghsfort_storm_spirit_static_remnant:Precache( context )
...
function aghsfort_storm_spirit_static_remnant:doAction(kv)
    ...
    local damage = self:GetSpecialValueFor("static_remnant_damage") + GetTalentValue(caster, "special_bonus_unique_storm_spirit_5")
...
function modifier_aghsfort_storm_spirit_static_remnant_thinker:OnCreated(kv)
	...
	EmitSoundOn( sound_cast, self.parent )
        ...
        --     "particles/units/heroes/hero_stormspirit/stormspirit_static_remnant.vpcf", PATTACH_CUSTOMORIGIN, nil)
