...
{
	{
		...
		ability_name = "dawnbreaker_fire_wreath",
		special_values =
		{
			{
...

	{
		...
		ability_name = "dawnbreaker_celestial_hammer",
		special_values =
		{
			{
	...
	
	{
		...
		ability_name = "dawnbreaker_luminosity",
...

	{
		...
		ability_name = "dawnbreaker_solar_guardian",
