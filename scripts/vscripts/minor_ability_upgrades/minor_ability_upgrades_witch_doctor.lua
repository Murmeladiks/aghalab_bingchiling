local Witch_Doctor =
{
...

	{
		 ...
		 ability_name = "witch_doctor_voodoo_restoration",
	...
	},
	{
		 ...
		 ability_name = "witch_doctor_maledict",
		 special_value_name = "bonus_damage_threshold",
		 operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		 value = 50,
	},	
	{
	...
	{
		description = "aghsfort_witch_doctor_voodoo_switcheroo_cooldown_manacost",
		ability_name = "witch_doctor_voodoo_switcheroo",
		special_values =
		{
			{
				special_value_name = "mana_cost",
	...
	{
		description = "aghsfort_witch_doctor_voodoo_switcheroo_duration",
		ability_name = "witch_doctor_voodoo_switcheroo",
