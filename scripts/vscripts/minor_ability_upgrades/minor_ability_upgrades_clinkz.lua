...
local Clinkz =
{
...

	{
		...
		ability_name = "clinkz_burning_barrage",
		special_values =
		{
			{
...

	{
		...
		ability_name = "clinkz_searing_arrows",
		special_values =
		{
			{
				special_value_name = "mana_cost",
...

	{
		...
		ability_name = "clinkz_wind_walk",
		special_value_name = "skeleton_count",
		operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		value = 1,
	},
	...
	--------------------------------------------------------------------------------
	{
		...
		ability_name = "clinkz_burning_army",
		special_values =
		{
			{
				special_value_name = "mana_cost",
