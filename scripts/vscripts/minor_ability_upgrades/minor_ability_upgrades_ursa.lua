...
{
	{
		description = "aghsfort_ursa_earthshock_shard_enrage_duration",
		ability_name = "ursa_earthshock",
		special_value_name = "shard_enrage_duration",
