local Mars =
{
	...
	{
		description = "aghsfort_mars_bulwark_physical_damage_reduction",
		ability_name = "aghsfort_mars_bulwark",
		special_value_name = "physical_damage_reduction",
		operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		value = 3,
	...
	{
		description = "aghsfort_mars_bulwark_physical_damage_reduction_side",
		ability_name = "aghsfort_mars_bulwark",
		special_value_name = "physical_damage_reduction_side",
		operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		value = 5,
	...
	{
		description = "aghsfort_mars_arena_of_blood_radius",
		ability_name = "aghsfort_mars_arena_of_blood",
		special_value_name = "radius",
		operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		value = 50,
