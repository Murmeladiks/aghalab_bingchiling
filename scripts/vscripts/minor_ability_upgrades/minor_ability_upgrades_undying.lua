local Undying =
{
...

	{
		 ...
		 ability_name = "undying_tombstone",
		 special_value_name = "zombie_damage_tooltip",
		 operator = MINOR_ABILITY_UPGRADE_OP_ADD,
		 value = 5,
	},
	{
...

	{
		 ...
		 ability_name = "undying_flesh_golem",
